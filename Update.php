...
if (isset($_SESSION['uid']) && $_SESSION['type']) {
  if (isset($_POST['submit']) && isset($_FILES['file'])) {
    ...
    if (move_uploaded_file($tmp, "pic/" . $file_name)) {
      $Update = "UPDATE property SET Title = '$Title',ptype ='$ptype',stype = '$stype',bhk = '$bhk',floor ='$floor',City = '$City',State = '$State', Area ='$Area', Price ='$price',file_name = '$file_name', Address ='$Address',uid='$uid' where id = $id";
