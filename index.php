<?php 
    ...
    if(isset($_POST['sell'])){
        ...
        $select = "select * From property where stype='sale'";
    }
    if(isset($_POST['rent'])){
        $select = "select * From property where stype='rent'";
    }    
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ...
                    <p class="animated fadeIn mb-4 pb-2">Makaan Properties was established in 2010 Dubai, UAE. The Company was made to be one of the leading real estate corporates in the country, the market and the experience team of multi-national agents specializing in different areas in the UAE
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div cl6ass="row g-0 gx-5 align-items-end">
                    <div class="col-lg-6">
